...
public partial class Ivan貓抓抓Context : DbContext
{
    public Ivan貓抓抓Context()
    {
    }

    public Ivan貓抓抓Context(DbContextOptions<Ivan貓抓抓Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=TEST_FANG;Initial Catalog=貓抓抓;Integrated Security=True;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GameShopAnnouncement>(entity =>
        {
            ...
            entity.Property(e => e.AnnouncementContent).IsRequired();
            ...
            entity.Property(e => e.AnnouncementTitle).IsRequired();
